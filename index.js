...
function MyReactComponent(props){
    ...
    const get_coin_details = ()=>{
        if (data.length> 0) {
            ...
            fetch(api_string,{
                method:'GET', headers: {'Accepts': 'application/json','X-CMC_PRO_API_KEY': '63be7f99-4796-49a3-8628-0f722749d66b', 'Access-Control-Allow-Origin': 'https://mehedii-hasann.github.io'}
              })
